...
export default function Stepper({
  ...
  return (
    <div
      className="flex h-screen bg-[url('/images/hero.png')] flex-col items-center justify-center p-4"
      {...rest}
    >
      <div
        className={`mx-auto w-full max-w-2xl rounded-4xl shadow-xl ${stepCircleContainerClassName} bg-[#9EBCB8]/60 backdrop-blur-md border border-white/20`}
        style={{ border: "1px solid #222" }}
      >
        <h1 className="font-bold text-black font-albert-sans text-shadow-2xs text-shadow-black text-5xl p-10">
    ...
    >
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: "#f4ece8", color: "#5227FF" },
          complete: { scale: 1, backgroundColor: "#f4ece8", color: "#3b82f6" },
        }}
      ...
      >
        {status === "complete" ? (
          ...
          <div className="h-3 w-3 rounded-full bg-[#006A4E]" />
        ) : (
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: "100%", backgroundColor: "#f4ece8" },
  };
